select ma.run_id dataflow_id, ma.execution_date dataflow_dtt, client_rk, 
...
group by  ac.client_rk) tb, (select * from dbt_schema.metadata_airflow_test where source_n = 'csv') ma
