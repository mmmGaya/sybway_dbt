  ...
  create view "postgres"."dbt_schema"."ins_to_e_sat__dbt_tmp"
...
select 
        ...
        'manual__2024-11-14T11:06:20.540690+00:00' dataflow_id,
        '2024-11-14 11:06:20.540690+00:00'::timestamp dataflow_dttm,
        md5(  name || '#' ||  phone || '#' ||  city || '#' ||  birthday || '#' ||  age ) hashdiff_key,
        md5(  id || '#' ||   oid) client_rk,
        0 delete_flg,
        1 actual_flg, 
        oid source_system_dk,
        '2024-11-14 11:06:20.540690+00:00'::timestamp valid_from_dttm
